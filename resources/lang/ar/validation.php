...
return [
    ...
    //         'unique' => 'الحساب مسجل بالفعل مع عنوان البريد الإلكتروني هذا',
    //     ],
    //     'password' => [
    ...
    //     ],
    //     'new_password' => [
    //         'required' => 'الرجاء إدخال كلمة مرور جديدة',
    //     ],
    //     'confirm_password' => [
    ...
    //     ],
    //     'poll_id' => [
    //         'required' => 'معرف الاستقصاء مطلوب',
    //     ],
    //     'option_id' => [
    //         'required' => 'معرف الخيار مطلوب',
    //     ],
    //     'poll_name' => [
    //         'required' => 'اسم الاستطلاع مطلوب',
    //     ],
    //     'options' => [
    //         'required' => 'الخيارات مطلوبة',
    //     ],
    //     'duration_id' => [
    //         'required' => 'معرف المدة مطلوب',
    //     ],
    //     'comment' => [
