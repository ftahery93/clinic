            ...
            <div class="panel panel-dark" data-collapsed="0">
                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-options">
                        @if ($CreateAccess==1)
                        <a href="{{ url('admin/serviceProviders/create')  }}" class="margin-top0">
                        ...
                        <a href="{{ url('admin/serviceProviders/trashedlist')  }}" class="margin-top0">
...
<script type="text/javascript">
                            jQuery(document).ready(function ($) {
                                ...
                                $table4.DataTable({
                                    ...
                                    "ajax": {
                                        "type": "GET",
                                        "url": '{{ url("admin/serviceProviders") }}',
                                        complete: function () {
                                            $('.loading-image').hide();
                                        }
                                    },
                                    columns: [
                                        ...
                                        {data: 5, name: 'country', class: 'text-center'},
...
// Removed the checked state from "All" if any checkbox is unchecked
                                        ...
                                        $('.status').on('click', function (e) {
                                            ...
                                            $.ajax({
                                                type: "PATCH",
                                                async: true,
                                                url: "{{ url('admin/serviceProviders')}}/"+ID,
