...
@section('title')
{{ $category_name}} Apply Quotation Form
@endsection
        ...
        <div class="panel panel-primary" data-collapsed="0" ng-app="ngDynamicForms">
            ...
            <div class="panel-heading">
                ...
                <div class="panel-options padding10">
                    <button type="button" class="btn btn-info btn-icon" id="preview" ng-click="myFunc()" ng-controller="FormBuilderCtrl">
    ...
    <div class="modal-dialog"  style="width: 30%;">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title">Apply Quotation Form</h4>
...
//            }];
    ...
    $('.loading-image').hide();
    $scope.posts = [];
    $http.get("{{ url('admin/categories/quotationFormPreview')}}/" + {{ $category_id}}).success(function ($data) {
    $scope.posts = $data.html;
    });
    }
    ...
    restrict: 'A',
            ...
            templateUrl: "{{ url('admin/categories/dynamicQuotationForm')}}"
    }
    });
...
<script>
    ...
    type: "POST",
            async: true,
            url: "{{ url('admin/categories/storeQuotation')}}",
            data: {jsonData: jsonData, category_id: {{ $category_id}}, _token: '{{ csrf_token() }}'},
    ...
    type: "GET",
            async: true,
            url: "{{ url('admin/categories/applyQuotationFormPreview')}}/" + {{ $category_id}},
            success: function (data) {
