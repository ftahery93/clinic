...
//            }];
    ...
    restrict: 'A',
            ...
            templateUrl: "{{ url('admin/categories/dynamicForm')}}"
    }
    });
...
<script>
    ...
    type: "POST",
            async: true,
            url: "{{ url('admin/categories/storeRequestQuotation')}}",
    ...
    type: "GET",
            async: true,
            url: "{{ url('admin/categories/quotationFormPreview')}}/" + {{ $category_id}},
            success: function (data) {
