...
Categories
@endsection
<form role="form" class="form-horizontal form-groups-bordered" autocomplete="off"   action="{{ url('/admin/categories/'. $Category->id)  }}" method="POST" id="form1" enctype="multipart/form-data">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            <div class="col-sm-12{{ $errors->has('description_en') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <textarea  class="form-control resize" name="description_en" id="description_en" >{{ $Category->description_en }}</textarea>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6" @if($Category->icon != '' || $Category->icon!=null) style="display:none;" @endif id="upload_image">
                            ...
                            <div class="col-sm-6"  id="uploaded_image">
                                ...
                                <div class="col-sm-9">
                                    <img src="{{ url('public/categories_icons/'.$Category->icon) }}" alt="Uploaded Icon" style="{{ $category_icon_WH }}">
