...
Countries
@endsection
<form role="form" class="form-horizontal form-groups-bordered" autocomplete="off"  method="POST" action="{{ url('/admin/countries') }}" id="form1">
    {{ method_field('POST') }}
    {{ csrf_field() }}
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6{{ $errors->has('country_code') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="country_code" autocomplete="off" value="{{ old('country_code') }}" name="country_code">
