                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6{{ $errors->has('fullname') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="fullname" autocomplete="off" value="{{ $RegisteredUser->fullname }}" name="fullname">
            ...
            <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6"  id="uploaded_image">
                                ...
                                <div class="col-sm-9">
                                    <img src="{{ url('public/images/'.$RegisteredUser->profile_image) }}" alt="Uploaded Icon" style="{{ $profile_WH }}">
