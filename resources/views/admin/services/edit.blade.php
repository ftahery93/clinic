...
<li>
    ...
    <a href="{{ url('admin/services').'/'.$category_id }}">Services</a>
</li>
@endsection
...
{{ $category_name }} - Services
@endsection
<form role="form" class="form-horizontal form-groups-bordered" autocomplete="off"   action="{{ url('admin/services/'. $Service->id.'/'.$category_id)  }}" method="POST" id="form1" enctype="multipart/form-data">
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-options padding10">
                        ...
                        <a href="{{ url('admin/services') }}" class="margin-top0">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6{{ $errors->has('name_ar') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="name_ar" autocomplete="off" value="{{ $Service->name_ar }}" name="name_ar" dir="rtl">
