...
{{ $category_name }} - Services
@endsection
<form class="form" role="form" method="POST" action="{{ url('admin/services/delete').'/'.$category_id  }}" >  
    {{ csrf_field() }} 
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-dark" data-collapsed="0">
                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-options">
                        @if ($CreateAccess==1)
                        <a href="{{ url('admin/services/create').'/'.$category_id  }}" class="margin-top0">
...
<script type="text/javascript">
                            ...
                            dom: 'lBfrtip',
                                    ...
                                    "ajax": {
                                    "type": "GET",
                                            "url": '{{ url("admin/services/$category_id") }}',
                                            complete: function () {
                                            $('.loading-image').hide();
                                            }
                                    },
...
// Removed the checked state from "All" if any checkbox is unchecked
                                    ...
                                    type: "PATCH",
                                            async: true,
                                            url: "{{ url('admin/services')}}/" + ID+'/'+{{ $category_id }},
