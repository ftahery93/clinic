                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6{{ $errors->has('num_points') ? ' has-error' : '' }}"  id="num_class">
                                ...
                                <label for="num_points" class="col-sm-3 control-label">No. of Inquires</label>
                            ...
                            <div class="col-sm-6{{ $errors->has('price') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="tel" class="form-control number_only" id="price" autocomplete="off"  name="price" value="{{ $Package->price }}"> 
                                    @if ($errors->has('price'))
                                    <span class="help-block">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6{{ $errors->has('expired_notify_duration') ? ' has-error' : '' }}">
                                <label for="expired_notify_duration" class="col-sm-3 control-label">Notify Before Expired</label>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $.validator.addMethod("currency", function (value, element) {
            return this.optional(element) || /^((?:[0-9]|1[0-9]|2[0-3])(?:\.\d{1,3})?|24(?:\.00?)?)$/.test(value);
