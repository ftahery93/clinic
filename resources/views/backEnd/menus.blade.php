        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center p-lg">
                <p>
                    {{ trans('backLang.confirmationDeleteMsg') }}
                    <br>
                    <strong>[ {{ $ParentMenu->title_ar }} ]</strong>
                </p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn dark-white p-x-md" data-dismiss="modal">{{ trans('backLang.no') }}</button>
                <a href="{{ route("parentMenusDestroy",["id"=>$ParentMenu->id]) }}" class="btn danger p-x-md">{{ trans('backLang.yes') }}</a>
            </div>
        </div><!-- /.modal-content -->
    </div>
</div>
                        ...
                        <div class="row p-a">
                            <div class="col-sm-12">
                                <a class="btn btn-fw primary" href="{{route("menusCreate",$edt_id)}}">
                                    <i class="material-icons">&#xe02e;</i>  &nbsp; {{ trans('backLang.newLink') }}
                                </a>
                            </div>
                        </div>
                    @endif
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped  b-t">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center" style="width:100px;">{{ trans('backLang.options') }}</th>
                                </tr>
                                </thead>
                                <tbody>
                                <?php
                                ...
                                @foreach($Menus as $Menu)
                                    ...
                                    <tr>
                                        <td>
                                            <label class="ui-check m-a-0">
                                                <input type="checkbox" name="ids[]" value="{{ $Menu->id }}"><i class="dark-white"></i>
                                    ...
                                    @foreach($Menu->subMenus as $subMenu)
                                        ...
                                        <tr>
                                            <td><label class="ui-check m-a-0">
                                                    <input type="checkbox" name="ids[]" value="{{ $subMenu->id }}"><i class="dark-white"></i>
                        ...
                        <footer class="dker p-a">
                            <div class="row">
                                <div class="col-sm-3 hidden-xs">
                                    ...
                                    <button id="submit_show_msg" class="btn btn-sm white" data-toggle="modal" style="display: none" data-target="#m-all" ui-toggle-class="bounce" ui-target="#animate">{{ trans('backLang.apply') }}</button>
                                </div>
