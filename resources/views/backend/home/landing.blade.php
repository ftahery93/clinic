...
<body>
        ...
        <div class="container navbar-container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
	                ...
	                <li class="nav-item">
	                    <a href="#section-subscribe1" class="nav-link">Contact</a>
	                </li>
                </ul>
            </div>
				...
				<div class="row">
					<div class="left col-sm-12 col-md-6">
						<div class="img-container">
							<img class="circleicon1 ez-animate" src="{{ asset('assets/images/img-circleicon1.png')}}" alt="Masafah" data-animation="fadeInUp">
							<img class="img-fluid ez-animate" src="{{ asset('assets/images/img-2.png')}}" alt="Masafah" data-animation="fadeInLeft">
						</div>
					</div>
		...
		<div class="section-features2">
			<div class="container">
				<div class="row">
					...
					<div class="left col-sm-12 col-md-6">
						<div class="img-container">
							<img class="circleicon1 ez-animate" src="{{ asset('assets/images/img-circleicon2.png')}}" alt="Masafah" data-animation="fadeInUp">
							<img class="img-fluid ez-animate" src="{{ asset('assets/images/img-3.png')}}" alt="Masafah" data-animation="fadeInRight">
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container appscreen1">
			<div class="row">
				<div class="owl-carousel owl-theme">
					<!-- Item -->
					<div class="item">
						<img class="img-fluid" src="{{ asset('assets/images/img-screen1.jpg')}}" alt="Masafah">
					</div>
					<!-- /.Item -->
					<!-- Item -->
					<div class="item">
						<img class="img-fluid" src="{{ asset('assets/images/img-screen2.jpg')}}" alt="Masafah">
					</div>
					<!-- /.Item -->
					<!-- Item -->
					<div class="item">
						<img class="img-fluid" src="{{ asset('assets/images/img-screen3.jpg')}}" alt="Masafah">
					</div>
					<!-- /.Item -->
					<!-- Item -->
					<div class="item">
						<img class="img-fluid" src="{{ asset('assets/images/img-screen4.jpg')}}" alt="Masafah">
					</div>
					<!-- /.Item -->
					<!-- Item -->
					<div class="item">
						<img class="img-fluid" src="{{ asset('assets/images/img-screen5.jpg')}}" alt="Masafah">
					</div>
					<!-- /.Item -->
					<!-- Item -->
					<div class="item">
		...
		<div class="container">
			<div class="row">
				<div class="col-12">
					...
					<p>and get started for your business</p>
					<ul>
						<li>
							<a href="#">
	...
	<div id="section-footer">
		...
		<div class="footer-copyright container-fluid ">
			<div class="col-12">
				<p>© 2019 Copyrights <a href="https://vavisa-kw.com">Vavisa IT Solutions</a></p>
			</div>
		</div>
	</div>
	<!-- /.Section Footer -->
