    ...
    <div class="padding">
        <div class="box">
            <div class="box-header dker">
                <h3><i class="material-icons">&#xe3c9;</i> {{ trans('backend.editPermissions') }}</h3>
                <small>
            ...
            <div class="box-body">
                {{Form::open(['route'=>['permissions_update',$Permissions->id],'method'=>'POST'])}}
                    ...
                    <div class="col-sm-10">
                        <div class="checkbox">
                            <label class="ui-check">
                                {!! Form::checkbox('companyusers_status','1',($Permissions->companyusers_status==1) ? true : false, array('id' => 'companyusers_status')) !!}
                        ...
                        <div class="checkbox">
                            <label class="ui-check">
                                {!! Form::checkbox('registeredusers_status','1',($Permissions->registeredusers_status==1) ? true : false, array('id' => 'registeredusers_status')) !!}
                                <i class="dark-white"></i><label
                        ...
                        <div class="checkbox">
                            <label class="ui-check">
                                {!! Form::checkbox('shipments_status','1',($Permissions->shipments_status==1) ? true : false, array('id' => 'shipments_status')) !!}
                                <i class="dark-white"></i><label
                        ...
                        <div class="checkbox">
                            <label class="ui-check">
                                {!! Form::checkbox('transactions_status','1',($Permissions->transactions_status==1) ? true : false, array('id' => 'transactions_status')) !!}
                                <i class="dark-white"></i><label
