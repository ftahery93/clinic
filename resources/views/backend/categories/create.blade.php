    ...
    <div class="padding">
        <div class="box">
            <div class="box-header dker">
                <h3><i class="material-icons">&#xe02e;</i> {{ trans('backend.categories') }}</h3>
                <small>
                    ...
                    <div class="col-sm-10">
                        <div class="radio">
                            <label class="ui-check ui-check-md" style="margin-bottom: 5px;">
                                {!! Form::radio('status','1',true, array('id' => 'status','class'=>'has-value')) !!}
                                <i class="dark-white"></i>
                                {{ trans('backend.active') }}
                            </label>
                            <br>
                            <label class="ui-check ui-check-md" style="margin-bottom: 5px;">
                                {!! Form::radio('status','0',false, array('id' => 'status','class'=>'has-value')) !!}
                                <i class="dark-white"></i>
