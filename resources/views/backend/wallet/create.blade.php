    ...
    <div class="padding">
        <div class="box">
            <div class="box-header dker">
                <h3><i class="material-icons">&#xe02e;</i> {{ trans('backend.wallet_offers') }}</h3>
                <small>
            ...
            <div class="box-body">
                {{Form::open(['route'=>['wallet_offers_store'],'method'=>'POST', 'files' => true ])}}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        {!! Form::text('amount','', array('placeholder' => '','class' => 'form-control','id'=>'name','required'=>'', 'dir'=>trans('backend.ltl    '))) !!}
                    </div>
                </div>
                <div class="form-group row">
                    <label for="name"
                    ...
                    <div class="col-sm-10">
                        {!! Form::text('free_deliveries','', array('placeholder' => '','class' => 'form-control','id'=>'name','required'=>'', 'dir'=>trans('backend.ltl    '))) !!}
                    </div>
                </div>
                @endif
