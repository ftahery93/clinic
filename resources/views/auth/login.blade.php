        ...
        <div class="navbar">
            <div class="pull-center">
                <div>
                    ...
                    {{-- <span lass="hidden-folded inline">{{ trans('backLang.control') }}</span> --}}
                </div>
            </div>
        </div>
        <div class="p-a-md box-color r box-shadow-z1 text-color m-a">
            <div class="m-b text-sm">{{ trans('backLang.signedInToControl') }}</div>
            <form name="form" method="POST" action="{{ url('/login') }}">
                ...
                <div class="m-b-md">
                    <label class="md-check">
                        <input type="checkbox" name="remember"><i class="primary"></i> {{ trans('backLang.keepMeSignedIn') }}
                    </label>
                </div>
