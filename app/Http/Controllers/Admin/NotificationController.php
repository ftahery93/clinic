        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($Notification)
                            ...
                            ->editColumn('sent_status', function ($Notification) {
                                return $Notification->status == 1 ? '<span class="badge badge-success badge-roundless">Sent</span>' : '<span class="badge badge-danger badge-roundless">Not Sent</span>';
                            })
                            ...
                            ->editColumn('num_sent', function ($Notification) {
                                return '6/5';
                            })
